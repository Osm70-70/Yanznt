...
/////////////////
const BotName = 'YANZ BOT☄'; 
const instagram = 'GA ADA'; 
const telegram = 'GA ADA'; 
const kapanbotaktif = 'KAMU NANYA?'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by YanzKullBet')
